...
const handleChatBotReply = async (
    ...
    try {
        ...
        const createBotMessage = await messageModel.createNewMessage(
            botMessage,
        );
            ...
            try {
                ...
                if (messageResults) {
                    const userConversation = {
                        ...
                        senderID: userID,
                        lastMessage:
                            messageResults[messageResults.length - 1].messageID,
                    };
                    //Xử lý song song
                    await Promise.all([
                        conversationModel.addUserToConversation(
            ...
            try {
                ...
                if (conversation) {
                    ...
                    const createNewMessage =
                        await messageModel.createNewMessage(messageData);
